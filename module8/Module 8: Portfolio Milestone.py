...
cart_class.customer_name = str(input("Enter customer's name: "))
cart_class.date = str(input("Enter today's date: "))
print("Customer name:", cart_class.customer_name)
print("Today's date:", cart_class.date)
